	    ...
	    <div class="container-fluid">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav m-auto">
	        	<li class="{{Request::path()==='/'?'nav-item active': ''}}"><a href="/" class="nav-link">Home</a></li>
	          ...
	          <li class="{{Request::path()==='contact'?'nav-item active': ''}}"><a href="/contact" class="nav-link">Contact</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
